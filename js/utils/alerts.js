const showNotification = (message, type = 'info') => {
    ...
    // Duración según importancia: Errores (8s), Advertencias (4s), Confirmación exitosa (1.5s rápida)
    const duration = type === 'error' ? 8000 : (type === 'warning' ? 4000 : (type === 'success' ? 1500 : 2000));
